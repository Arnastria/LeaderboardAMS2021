...
// Create connection
$conn = new mysqli($nost, $username, $password, $dbname);
...
$sql = "select * from person_result order by `complete set precision` desc, `complete set recall` desc, `complete set f1-score` desc";
$result_person = $conn->query($sql);

$sql = "select * from gender_result order by `complete set precision` desc, `complete set recall` desc, `complete set f1-score` desc";
$result_gender = $conn->query($sql);

$sql = "select * from origin_9_result order by `complete set precision` desc, `complete set recall` desc, `complete set f1-score` desc";
$result_origin_9 = $conn->query($sql);

$sql = "select * from origin_2_result order by `complete set precision` desc, `complete set recall` desc, `complete set f1-score` desc";
$result_origin_2 = $conn->query($sql);

$sql = "select * from ethnic_group_result order by `complete set precision` desc, `complete set recall` desc, `complete set f1-score` desc";
