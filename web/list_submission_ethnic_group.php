...
$sql = 'SELECT GroupName, UploadKey, filename, mime, size, data, updated, TesterAccuracy, TesterPrecision, TesterRecall, TesterF1Score FROM ethnic_group_submission_logs ORDER BY GroupName, updated DESC';
        ...
        while($row = $result->fetch_assoc()) {
            ...
            echo "
                <tr>
					...
					<td>
					<a href='download_ethnic_group.php?id=$groupName&updated=$waktu'>
					Download
					</a>
					</td>
